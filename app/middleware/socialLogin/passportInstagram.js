module.exports = passport => {
    ...
    callbackURL: process.env.SITE_API_URL + "users/social_login/instagram/callback/"
  },
  async function(accessToken, refreshToken, profile, done) {
    ...
    const linkEnd = username ? instagramDomain + username : instagramDomain + id;
    const usernameEnd = username ? username : ( emailEnd ? emailEnd : null ) ;
        ...
        if (UserDetails) {
            ...
            const data = {
                ...
                "u_ymail_id": "",
                "u_pref_login": 0,
                "u_instagram_username": usernameEnd ? usernameEnd.toString() : "",
                "u_instagram_id": id
            }
            Users.create(data)
                .then(data => {
