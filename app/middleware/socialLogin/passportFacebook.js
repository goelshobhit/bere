module.exports = passport => {
    ...
    callbackURL: process.env.SITE_API_URL + "users/social_login/facebook/callback",
    profileFields: ['link', 'email']
  },
  async function(accessToken, refreshToken, profile, done) {
    ...
    const { id, username, emails, link} = profile;
    ...
    const linkEnd = link ? link : (username ? facebookDomain + username : facebookDomain + id);
    const usernameEnd = username ? username : ( emailEnd ? emailEnd : null ) ;
        ...
        if (UserDetails) {
            ...
            const data = {
                ...
                "u_active": true,
                "u_fb_username": usernameEnd ? usernameEnd.toString() : "",
                "u_fb_id": id,
                "u_gmail_username": "",
                "u_gmail_id": "",
                "u_ymail_username": "",
