module.exports = passport => {
    ...
    state: true,
    callbackURL: process.env.SITE_API_URL + "users/social_login/pinterest/callback/"
  },
  async function(accessToken, refreshToken, profile, done) {
    ...
    const pinterestDomain = "https://www.pinterest.com/";
    const emailEnd = (emails && emails.length > 0) ? emails[0].value : null 
    const linkEnd = username ? pinterestDomain + username : instagramDomain + id;
    const usernameEnd = username ? username : ( emailEnd ? emailEnd : null ) ;
        ...
        if (UserDetails) {
            ...
            const data = {
                ...
                "u_instagram_id": "",
                "u_pinterest_username": usernameEnd ? usernameEnd.toString() : "",
                "u_pinterest_id": id,
                "u_twitter_username": "",
                "u_twitter_id": "",
                "u_tiktok_username": "",
