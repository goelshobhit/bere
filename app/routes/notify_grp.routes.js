module.exports = app => {
   ...
   */
	router.post("/notify/groups", NotifyGrp.createNotifyGrp);
  /**
   * @swagger
   ...
   *                              example: Authorisation Required
   */
   router.put("/notify/groups/:notifyGrpId", NotifyGrp.updateNotifyGrp);
  /**
   * @swagger
   * /api/notify/groups:
   *   get:
   ...
   *                              example: Authorisation Required
   */
    router.get('/notify/groups', NotifyGrp.notifyGrpListing)
  /**
   * @swagger
   * /api/notify/groups/{notifyTrigGrpId}:
   *   get:
   ...
   *                              example: Authorisation Required
   */
    router.get("/notify/group/:notifyGrpId", NotifyGrp.notifyGrpDetails);
    app.use("/api", router);
};
