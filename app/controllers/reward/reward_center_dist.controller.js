...
exports.createRewardCenterDist = async(req, res) => {
    ...
    const RewardCenterDist = {
        ...
        "reward_center_dist_one_keys_to_token": body.hasOwnProperty("Keys To Token") ? body["Event UsrOptOut Date"] : 0,
        "reward_center_dist_one_booster": body.hasOwnProperty("One Booster") ? body["Event UsrOptOut Date"] : 0,
