...
exports.updateBonusTicketRules = async (req, res) => {
    ...
    BonusTicketRules.update(requested_body, {
        returning: true,
        where: {
            ...
            if (bonusTicketRequestRules.length) {
                for (const bonusTicketRuleKey in bonusTicketRequestRules) {
                    ...
                    if (bonusTicketRequestRules[bonusTicketRuleKey]['bonus_ticket_rule_detail_id'] != undefined) {
                        ...
                        BonusRuleDetail.update(bonusTicketRequestRules[bonusTicketRuleKey], {
                            returning: true,
                            where: {
                                ...
                                return res.status(500).send({
                                    message: "Error updating Bonus Ticket Rule Detail with id=" + requested_rule_detail_id
                                });
                            });
                    } else {
                        BonusRuleDetail.create({
                            ...
                            .catch(err => {
                                ...
                                return res.status(500).send({
                                    message:
                                        err.message || "Some error occurred while creating the Bonus Ticket Rule Detail."
                                });
                            });
                    }
